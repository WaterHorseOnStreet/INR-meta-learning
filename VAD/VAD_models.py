...
class FFLayer(nn.Module):
    ...
    def __init__(self, input_size, output_size, layer_norm, dropout, activation):
        ...
        self.hiddens.append(self.layer_norm)
        self.hiddens.append(self.layer)
        self.hiddens.append(self.dropout)
        self.hiddens.append(self.activation)
...
class MaskedVAD2(MaskedDecoder):
    ...
    def forward(self, latents):
        ...
        return transformed[:, :, :2].contiguous().view(-1, 84 * 2), 