...
# apply latent z to every single pixel of input x, the latent y may 
# learned by other styled images 
######################################################################
...
class CINResnetBlock(TwoInputModule):
    def __init__(self, x_dim, z_dim, padding_type='reflect', norm_layer=CondInstanceNorm, use_dropout=True, use_bias=True):
...
class ResnetBlock(nn.Module):
    def __init__(self, dim, padding_type='reflect', norm_layer=InstanceNorm2d, use_dropout=True, use_bias=True):
...
# a two-arm parallel placed resnet, output is concat of two outputs from two arms in channel dimension
class ResnetBlock_unbalance(nn.Module):
    def __init__(self, dim1, dim2, padding_type='reflect', norm_layer=InstanceNorm2d, use_dropout=True, use_bias=True):
...
class FCNBlock(nn.Module):
    ...
    def forward(self,x):
        ...
        #     print('expect dim {} but {} is given'.format(self.in_dim, x.shape[1])) 
