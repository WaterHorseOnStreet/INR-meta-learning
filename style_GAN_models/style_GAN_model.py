...
class ToW(nn.Module):
    def __init__(self,in_channel,out_channel, in_dim, out_dim=512):
        super().__init__()
...
class MixVisionTransformer(nn.Module):
    ...
    def __init__(self,
        ...
        self.ToW1 = ToW(embed_dims[0],6,img_size//4)
        ...
        self.ToW2 = ToW(embed_dims[1],4,img_size//8)
        ...
        self.ToW3 = ToW(embed_dims[2],4,img_size//16)
        ...
        self.ToW4 = ToW(embed_dims[3],4,img_size//32)
